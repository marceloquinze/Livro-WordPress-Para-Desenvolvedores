...
function aprendawp_config(){
	register_nav_menus(
		array(
			'aprendawp_main_menu' 	=> __( 'Aprenda WP Main Menu', 'aprendawp' ),
			'aprendawp_footer_menu' => __( 'Aprenda WP Footer Menu', 'aprendawp' ),
		)
	);
...
function aprendawp_sidebars(){
	register_sidebar( array(
		'name'			=> __( 'Aprenda WP Main Sidebar', 'aprendawp' ),
		'id'			=> 'aprenda-wp-sidebar-1',
		'description'	=> __( 'Drag and drop your widgets here', 'aprendawp' ),
	...
	register_sidebar( array(
		'name'			=> __( 'Footer Sidebar 1', 'aprendawp' ),
	...
	register_sidebar( array(
		'name'			=> __( 'Footer Sidebar 2', 'aprendawp' ),
	...
	register_sidebar( array(
		'name'			=> __( 'Footer Sidebar 3', 'aprendawp' ),
	...
	register_sidebar( array(
		'name'			=> __( 'Sidebar Shop', 'aprendawp' ),
		'id'			=> 'aprenda-wp-sidebar-shop',
		'description'	=> __( 'Drag and drop your WooCommerce widgets here', 'aprendawp' ),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s widget-wrapper">', 
		'after_widget'	=> '</div>',
		'before_title'	=> '<h4 class="widget-title">',
		'after_title'	=> '</h4>',
